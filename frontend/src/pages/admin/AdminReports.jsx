              ...
              {reportType === "sales" ? (
                <>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <TrendingUp className="w-8 h-8 text-[#F4A261]" />
                        <div>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      <div className="flex items-center gap-3">
                        <Package className="w-8 h-8 text-[#E76F51]" />
                        <div>
                ...
                <>
                  ...
                  <Card>
                    <CardContent className="p-4">
                      ...
                      <p className="text-2xl font-bold text-[#F4A261]">{report.summary?.total_bookings || 0}</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4">
                      <p className="text-sm text-[#636E72]">Total Requests</p>
                      <p className="text-2xl font-bold text-[#E76F51]">{report.summary?.total_requests || 0}</p>
                    </CardContent>
                  </Card>
                  <Card>
                    <CardContent className="p-4">

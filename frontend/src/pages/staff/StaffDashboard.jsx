  ...
  const renderOrders = () => (
    <div className="space-y-4">
      {orders.length === 0 ? (
        ...
        orders.map((order) => (
          <Card key={order.id} className="border-l-4 border-l-[#F4A261]">
  ...
  const renderRequests = () => (
    <div className="space-y-4">
      {requests.length === 0 ? (
        ...
        requests.map((req) => (
          <Card key={req.id} className="border-l-4 border-l-[#E76F51]">
            <CardContent className="p-4">
              <div className="flex justify-between items-start mb-2">
                <div>
      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="flex gap-2 mb-4 overflow-x-auto">
          <Button
            ...
            className={activeTab === "orders" ? "bg-[#F4A261]" : ""}
          >
          ...
          <Button
            ...
            className={activeTab === "requests" ? "bg-[#E76F51]" : ""}
          >

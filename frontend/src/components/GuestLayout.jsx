...
import { Home, Compass, UtensilsCrossed, MessageSquare, ShoppingCart, ClipboardCheck } from "lucide-react";
import { getCartCount, getPropertyId, getPropertySlug } from "@/lib/store";
    ...
    <div className="min-h-screen bg-[#FBF9F6]">
      ...
      {showNav && (
        <nav className="floating-dock" data-testid="guest-nav">
          ...
          {/* Check-in Button */}
          <button
            onClick={() => navigate(`/${propertySlug}/checkin`)}
            className={`dock-item ${location.pathname.includes("/checkin") ? "active" : ""}`}
